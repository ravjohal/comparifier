...
module RubyAMF
  module Configuration
    ...
    # A Class Mapping definition consists of at least these two properties:
    ...
    # ClassMappings.register(:actionscript => 'User', :ruby => 'User', :type => 'active_record', :associations=> ["addresses", "credit_cards"], :methods => ["friends"])
      ...
      :actionscript  => 'com.comparifier.nozama.vo.CategoryVO',
      :ruby          => 'Category',
      :type          => 'active_record',
      :associations  => ["comparifier_attributes"],
      :attributes    => ["id", "vendorCategoryId", "name", "searchIndex", "description", "operation", "vendor", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'com.comparifier.nozama.vo.ComparifierAttributeVO',
      :ruby          => 'ComparifierAttribute',
      :type          => 'active_record',
      :associations  => ["items", "categories"],
      :attributes    => ["id", "name", "value", "category_id", "item_id", "created_at", "updated_at"])

#    ClassMappings.register(
#      :actionscript  => 'com.comparifier.nozama.vo.ComparifierRequest',
#      :ruby          => 'ComparifierRequest',
#      :type          => 'active_record',
#      :attributes    => ["id", "vendorRequestId", "vendor", "operation", "service", "accessKeyId", "responseType", "responseGroup", "version", "keywords", "response", "request", "requestDate", "totalResults", "totalPages", "condition", "reviewSort", "merchantId", "created_at", "updated_at"])

    ClassMappings.register(
      :actionscript  => 'com.comparifier.nozama.vo.ItemVO',
      :ruby          => 'Item',
      :type          => 'active_record',
      :associations  => ["images", "offers", "customer_reviews", "editorial_reviews", "similar_products", "accessories", "listmanias"],
      :attributes    => ["id", "vendorItemId", "name", "description", "operation", "vendor", "detailPageURL", "salesRank", "lowestNewPrices", "lowestUsedPrice", "lowestRefurbishedPrice", "totalNew", "totalUsed", "totalRefurbished", "totalCollectible", "totalOffers", "listPrice", "offerPrice", "avgCustRating", "totalReviews", "totalReviewPages", "created_at", "updated_at"])
         #
